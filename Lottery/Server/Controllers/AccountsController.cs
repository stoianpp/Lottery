...
namespace Lottery.Server.Controllers
{
    ...
    public class AccountsController : ControllerBase
    {
        ...
        {
            var adminId = _userManager.GetUserId(this.ControllerContext.HttpContext.User);
            var user = new IdentityUser { UserName = model.Email, Email = model.Email, PhoneNumber = adminId };
